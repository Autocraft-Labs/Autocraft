...
function getInitialTheme(): Theme {
  try {
    const stored = localStorage.getItem("autocraft-theme")
...
function App() {
  ...
  useEffect(() => {
    ...
    try {
      localStorage.setItem("autocraft-theme", theme)
    } catch {
  ...
  return (
    <ThemeContext.Provider value={{ theme, toggleTheme }}>
      <ErrorBoundary githubRepo="https://github.com/autocraft/autocraft">
