    ...
    >
      ...
      <LegalSection title="6. Data Retention">
        <p>
          ...
          <a
            href="https://github.com/autocraft/autocraft/blob/main/docs/legal/reward-distribution-policy.md"
      ...
      <LegalSection title="11. Contact">
        <p>
          Privacy inquiries:{" "}
          <a href="mailto:privacy@autocraft.com" className="text-foreground font-bold underline">
            privacy@autocraft.com
          </a>
        </p>
      </LegalSection>
    </LegalPageLayout>
