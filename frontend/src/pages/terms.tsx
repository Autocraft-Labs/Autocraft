  ...
  return (
    ...
    >
      ...
      <LegalSection title="2. Platform Description">
        ...
        <p>
          AUTOCRAFT does not custody your funds. All transactions are signed by your wallet (e.g.
      ...
      <LegalSection title="10. Contact">
        <p>
          ...
          <a href="mailto:legal@autocraft.com" className="text-foreground font-bold underline">
            legal@autocraft.com
          </a>
        </p>
      </LegalSection>
