...
export function Landing({ onNavigate }: LandingProps) {
  const subtitle = useTypewriter(
    "Create quests, set milestones, and reward builders with tokens. The first build-to-earn platform on Stellar.",
    25
  )
      ...
      >
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6">
          <div className={`reveal-up mb-16 text-center ${featInView ? "in-view" : ""}`}>
            <h2 className="mb-5 text-4xl font-black sm:text-5xl">Why AUTOCRAFT?</h2>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6">
          <div className="grid grid-cols-1 gap-10 py-12 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <div>
              <div className="mb-4 flex items-center gap-3">
                ...
                <span className="text-xl font-black">AUTOCRAFT</span>
              </div>
              <p className="text-muted-foreground max-w-xs text-sm leading-relaxed">
                The first build-to-earn platform on Stellar. Create quests, set milestones, reward
                builders with tokens.
              </p>
            </div>
            ...
            <div>
              ...
              <div className="flex flex-col gap-3">
                {[
                  { label: "Documentation", href: "https://github.com/autocraft/autocraft" },
                  {
                    label: "Contributing",
                    href: "https://github.com/autocraft/autocraft/blob/main/CONTRIBUTING.md",
                  },
                  {
                    label: "MIT License",
                    href: "https://github.com/autocraft/autocraft/blob/main/LICENSE",
                  },
                ].map(link => (
                  <a
                    key={link.label}
            ...
            <div>
              ...
              <div className="flex gap-3">
                {[
                  { href: "https://github.com/autocraft", label: "GitHub", Icon: GithubIcon },
                  { href: "https://x.com/autocraft", label: "X", Icon: XIcon },
                  { href: "https://discord.gg/autocraft", label: "Discord", Icon: DiscordIcon },
                ].map(social => (
                  <a
                    key={social.label}
                    href={social.href}
          ...
          <div className="border-border flex flex-col items-center justify-between gap-3 border-t-2 py-5 sm:flex-row">
            ...
            <p className="text-muted-foreground text-xs">
              &copy; {new Date().getFullYear()} AUTOCRAFT
            </p>
          </div>
        </div>
      </footer>
