...
const FOOTER_LINKS = [
  { label: "About", href: "/" },
  { label: "Docs", href: "https://github.com/autocraft/autocraft/tree/main/docs" },
  { label: "Contact", href: "mailto:hello@autocraft.dev" },
] as const
    ...
    <div className="bg-background text-foreground flex min-h-screen flex-col">
      ...
      <footer className="border-border bg-secondary/40 border-t-[3px]">
        <div className="mx-auto flex max-w-7xl flex-col gap-4 px-4 py-5 sm:px-6 md:flex-row md:items-center md:justify-between">
          <div>
            <p className="text-sm font-black tracking-wide uppercase">AUTOCRAFT</p>
            <p className="text-muted-foreground mt-1 text-xs font-medium">
              Build-to-earn quests on Stellar.
            </p>
          </div>
