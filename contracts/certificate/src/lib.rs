...
impl CertificateContract {
    ...
    pub fn __constructor(env: Env, owner: Address) {
        ...
        Base::set_metadata(
            &env,
            String::from_str(&env, "https://autocraft.io/certificates"),
            String::from_str(&env, "Autocraft Quest Completion Certificates"),
            String::from_str(&env, "AUTOCRAFT_CERT"),
        );
    ...
    /// Removes all Autocraft metadata and mappings, sets a `RevokedCertificate`
