...
// Quest contract: the entry point for Autocraft.
// An owner creates a quest, enrolls builders, configures a reward token.
...
pub enum Error {
    ...
    /// System band: code 400 is identical across all Autocraft contracts.
    Paused = 400,
}
